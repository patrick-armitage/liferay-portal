...
<c:if test='<%= !type.equals("assetCategories") && !type.equals("checkbox") && !type.equals("radio") && !type.equals("hidden") && Validator.isNotNull(label) %>'>
	<label <%= labelTag %>>
